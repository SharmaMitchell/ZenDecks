  ...
  return (
    <div className={styles.about}>
      ...
      <motion.h2
        ...
        className={styles.about__title__subtitle}
      >
      ...
      >
        <div>
          <p>
            ...
            learning technique, which has been proven to be the most effective
            way to learn and retain information.
          </p>
          <p>
            As you study, ZenDecks will automatically adjust the frequency of
            your reviews, honing in on difficult cards and focussing less on
            easy cards. This means that you'll spend less time studying, and
            you'll remember more.
          </p>
          <p>
            Based on the Ebbinghaus forgetting curve, ZenDecks will show you
            cards at the optimal time to maximize your retention. Combined with
            your personalized card difficulty data, our spaced repetition
            algorithm will develop an optimal study schedule for you.
          </p>
        </div>
      ...
      {extended ? (
        <>
          ...
          >
            ...
            <p>
              ZenDecks is completely free and open source. We don't collect any
              user information, and we don't show any ads. We also don't have
              any paywalls or premium features. We believe that education should
          ...
          >
            ...
            <p>
              ...
              early public Alpha stage, with many features to come. If you’d
              like to support the development of the app, you can send a
              tip/donation to the lead developer, Mitchell, via{" "}
              <a
                target="blank"
                rel="noreferrer"
